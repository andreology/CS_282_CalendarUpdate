...
int main()
{
	...
	cout << "(3)Right now there are " << upDate::GetDateCount() + 1 << " upDate objects\n";
	{
		upDate d1, d2, d3;
		cout << "(6)Inside this block there are " << upDate::GetDateCount() + 1 << " upDate objects\n";
	}
	cout << "(3)Outside the block there are " << upDate::GetDateCount() + 2  << " upDate objects\n";
